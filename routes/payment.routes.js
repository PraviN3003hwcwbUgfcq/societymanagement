...
import { createPayment , getPayments , getUserPayments , getAdminData, deletePayment , updatePayment, payPayment,  verifyPayment , paymentStream, generateMonthlyMaintenance} from "../controllers/payment.controllers.js";
...
router.route("/generate-monthly").post(verifyJWT, generateMonthlyMaintenance);
