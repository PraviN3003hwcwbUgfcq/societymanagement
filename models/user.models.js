...
const userSchema = new Schema({
  ...
  role: {
    ...
    enum: ["user", "admin", "security", "treasurer", "secretary"],  // ✅ enum inside the object
...
//   role: {
//     type: String,
//     enum: ["user", "admin", "security", "treasurer", "secretary"],
//     default: "user",
//     required: true
//   },
...
//     validate: {
//       validator: function (value) {
//         return this.role === "admin" || this.role === "security" || this.role === "treasurer" || this.role === "secretary"
//           ? !!value
//           : true;
//       },
//       message: "rolePass is required for admin, security, treasurer and secretary roles",
//     },
//   },
//   name:
//   {
